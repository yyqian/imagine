 ...
 * the repository interface. Spring Data JPA creates an implementation on the fly when you run the application.
 *
 * In summary:
 ...
 * JpaRepository: findAll() will return List<T>, the transaction timeout for save() is customized to 10 secs.
 */

// @Repository is optional, just for the sake of Intellij IDEA. IDEA will complain without it.
@Repository
